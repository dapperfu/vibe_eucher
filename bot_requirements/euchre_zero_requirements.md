...
## Training Method
### Self Play
- All four players controlled by EuchreZero.
...
## Summary
EuchreZero is a full AlphaZero style implementation adapted for Euchre. Hidden information is handled through belief sampling inside MCTS. Legality is learned via harsh penalties. Risk tuning allows adjustable play styles. Self play produces superhuman strategy once trained at scale.
