...
from .mcts.search import EucherGoMCTSSearch
from .networks.model import EucherGoModel
from .state_encoder import EucherGoStateEncoder
from .utils.belief_tracker import BeliefTracker
...
class EucherGoPlayer(PlayerProfile):
    ...
    def decide_order_up(
        ...
        # Run MCTS with fewer simulations for hand-level decisions
        policy = self.mcts.search(state_tensor, action_mask, num_simulations=self.hand_simulations)
    ...
    def play_card(
        ...
        # Run MCTS with more simulations for trick-level decisions
        policy = self.mcts.search(state_tensor, action_mask, num_simulations=self.trick_simulations)
