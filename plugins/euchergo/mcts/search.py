...
from .tree import EucherGoMCTSNode
...
class EucherGoMCTSSearch:
    ...
    def search(
        ...
        num_simulations : Optional[int]
            Number of simulations to run. If None, uses self.num_simulations.
        ...
        sims_to_run = num_simulations if num_simulations is not None else self.num_simulations
