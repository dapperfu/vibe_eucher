...
class EucherZeroPlayer(PlayerProfile):
    ...
    def decide_order_up(
        ...
        policy = self.mcts.search(state_tensor, self.risk_factor, num_simulations=self.hand_simulations)
    ...
    def play_card(
        ...
        policy = self.mcts.search(state_tensor, self.risk_factor, num_simulations=self.trick_simulations)
