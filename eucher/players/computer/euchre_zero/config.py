...
class EuchreZeroConfig:
    """Configuration for EuchreZero model and training."""
    ...
    def __init__(
        ...
        """
        Initialize EuchreZero configuration.
        ...
        checkpoint_dir : Optional[str]
            Checkpoint directory (default: models/checkpoints/euchre_zero).
        """
        ...
        if checkpoint_dir is None:
            self.checkpoint_dir = Path("models/checkpoints/euchre_zero")
        else:
