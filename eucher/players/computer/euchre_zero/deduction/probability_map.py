...
from eucher.players.computer.euchre_zero.deduction.card_tracker import CardTracker
...
class ProbabilityMap:
    ...
    def sample_hidden_state(self) -> Dict[int, List[Card]]:
        ...
        # We know our hand
        from eucher.players.computer.euchre_zero.deduction.card_tracker import CardLocation
