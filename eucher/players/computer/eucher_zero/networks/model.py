"""Unified EucherZero model combining all networks."""
...
from eucher.players.computer.eucher_zero.networks.representation import (
    RepresentationNetwork,
)


class EucherZeroModel(nn.Module):
    """Unified model combining representation, dynamics, and prediction networks."""

    def __init__(self, config: EucherZeroConfig) -> None:
        """
        Initialize EucherZero model.
