...
This script generates a Jupyter notebook for analyzing Level3 tournament results.
"""
...
def main():
    """Generate the tournament analysis notebook."""
    with open('level3_tournament_analysis.ipynb', 'w') as f:
        json.dump(notebook_content, f, indent=2)
    
    print("✅ Generated level3_tournament_analysis.ipynb")
