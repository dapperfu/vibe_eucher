...
scripts/euchre_zero/   # Training scripts (matches pytorch_ai/, transformer_rl/ pattern)
...
python scripts/euchre_zero/train_euchre_zero.py \
    --config euchre_zero_config.yaml \
    --num_games 100 \
    --num_iterations 1000

# Or use shell wrappers
./scripts/euchre_zero/train_euchre_zero_gpu.sh
```
