# Weighted Heuristic Bot

## Overview

The Weighted Heuristic Bot (formerly called "AI Bot") is like the Heuristic Bot, but much smarter. Instead of simple yes/no rules, it uses a scoring system to evaluate situations.
