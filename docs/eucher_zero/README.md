# EucherZero Implementation Documentation

## Overview

This directory contains comprehensive documentation for implementing EucherZero, an AlphaZero/MuZero-inspired reinforcement learning system for Euchre.
...
### Training Approach
- Self-play with 4 EucherZero players
