...
def run_single_game(
    ...
    # Set model paths and simulation counts if provided
    # Note: This would need to be done through kwargs in _create_profile
    # For now, we'll rely on default model loading behavior
