...
def main() -> None:
    ...
    parser.add_argument(
        "--checkpoint-dir",
        type=str,
        default="models/checkpoints/euchre_zero",
        help="Checkpoint directory (default: models/checkpoints/euchre_zero)",
    )
    parser.add_argument(
        "--checkpoint",
        type=str,
    ...
    try:
        while True:
            ...
            for game_num in range(config.num_games):
                ...
                try:
                    # Create game with 4 EuchreZero players
                    player_config = [
                    ...
                    # Set game reference for all EuchreZero players
