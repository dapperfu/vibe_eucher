...
def main() -> None:
    ...
    # Create game with 2 EuchreZero bots vs 2 baseline players
    player_config = [
        ("EuchreZero_0", "euchre_zero"),  # Team 0
        ("Heuristic_1", "heuristic"),  # Team 1
        ("EuchreZero_2", "euchre_zero"),  # Team 0
    ...
    # Set game reference for EuchreZero players
